...
export const playlists:PlaylistInterface[] = [
   {id:1,nome:'pop brasil',foto:"assets/teste1.png", musicas: [Musicas[0], Musicas[2], Musicas[1]]},
   {id:2,nome:'brasil 360',foto:"assets/teste2.png", musicas:[Musicas[4], Musicas[6]]},
   {id:3,nome:'hip-hop',foto:"assets/teste3.jpg", musicas:[Musicas[3], Musicas[5]]},
